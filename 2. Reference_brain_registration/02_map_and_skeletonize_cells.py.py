...
python3 02_map_and_skeletonize_cells.py \
    ...
    --transform-prefix Zebrafish_CLEM/2. Reference_brain_registration/ANTs_transforms/clem_zfish1_to_zbrain \
...
def main() -> None:
    ...
    for idx, cell_dir in enumerate(cell_dirs, start=1):
        ...
        try:
            ants_reg.map_and_skeletonize_cell(
                ...
                input_limit_x=523776,   # (1024 px - 1) × 512 nm per voxel
                input_limit_y=327168,   # (640 px  - 1) × 512 nm
                input_limit_z=120000,   # (251 planes - 1) × 480 nm
                input_scale_x=0.001,     # convert nm → µm
                input_scale_y=0.001,
                input_scale_z=0.001,
            )
    ...
    logger.info("Mapping & skeletonization completed for all cells.")
