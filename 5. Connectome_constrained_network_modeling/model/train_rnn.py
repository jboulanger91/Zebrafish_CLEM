...
save_model = True
fit_model = True
path_load = None  # r"C:\Users\Roberto\Academics\data\models\rnn_ds\dales_fit_U\integrator_neurons10_tau0.5_input2step\model_2025-12-01_15-33-27.pkl"  #
path_load_mask = Path(r"/home/kn/kn_pop542534/data/rnn_ds/traces/results/mask_traces_freepop16/RNNFreePop_neurons102_tau0.1_input2step_softplus/top_5/model_top0_2026-03-03_03-11-48.pkl")
...
# Paths
path_traces = Path(r"/home/kn/kn_pop542534/data/rnn_ds/traces/from_jon")  # Path(r"C:\Users\Roberto\Desktop\highlights\clem_rnns\data")  #
path_save = path_traces / "results" / f"mask_traces_freepop{n_free_neurons}_loadtop0"
...
#     signal += np.abs(np.min((0, np.min(signal))))
#     return signal
