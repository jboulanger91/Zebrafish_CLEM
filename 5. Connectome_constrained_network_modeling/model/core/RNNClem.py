...
class RNNClem(nn.Module):
    def __init__(
            ...
            E_frac_A=0.3, E_frac_B=0.3, E_frac_C=0.3, E_frac_D=0.3,
            sparsity_U=1,
            # intra-hemisphere sparsity
            sparsity_AA=0.1125, sparsity_AB=0.18, sparsity_AC=0.475, sparsity_AD=0.065,
            sparsity_BA=0, sparsity_BB=0, sparsity_BC=0, sparsity_BD=0,
            sparsity_CA=0.08, sparsity_CB=0.45, sparsity_CC=0.09, sparsity_CD=0.04,
            sparsity_DA=0.02, sparsity_DB=0, sparsity_DC=0, sparsity_DD=0,
        ...
        self.n_units = self.n_hemi * self.n_units_hemi
        self.n_out = 8
