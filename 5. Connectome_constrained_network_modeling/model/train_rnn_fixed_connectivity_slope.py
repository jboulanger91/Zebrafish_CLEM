...
from model.core.RNNFixedConnectivitySlope import RNNFixedConnectivitySlope
...
if __name__ == '__main__':
    ...
    if path_load is not None:
        ...
        beta_init = np.random.uniform(0.1, 2)
        rnn = RNNFixedConnectivitySlope(W_norm, dict_neurons, fixed_U=fixed_U,
                                   sparsity_U=1, tau=tau_neuron, dt=dt,
                                   seed=seed, clamp_weights_min=1e-2, beta_init=beta_init)
    ...
    if save_model:
        ...
        label_model = f"RNNFixedConnectivitySlope_neurons{n_units}_U{label_U}"
